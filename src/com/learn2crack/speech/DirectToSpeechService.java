 ...
 * 
 */
public class DirectToSpeechService extends Service implements
        SpeechActivationListener
{
    private static final String TAG = "DirectToSpeechService";
    ...
    {
        Intent i = new Intent(context, DirectToSpeechService.class);
    ...
    private SpeechActivator getRequestedActivator(Intent intent)
    {
        ...
        SpeechActivator speechActivator =
        		new WordActivator(this, this, "hello");
    ...
    private Notification getNotification(Intent intent)
    {
        ...
        int icon = intent.getIntExtra(NOTIFICATION_ICON_RESOURCE_INTENT_KEY, 0x7f020000);
